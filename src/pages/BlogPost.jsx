              ...
              <div className="post-glyph" aria-hidden>
                <svg viewBox="0 0 200 200" width="100%" height="auto">
                  ...
                  <g className="glyph-spin-cw">
                    ...
                    <circle cx="100" cy="8"   r="1.6" fill="#A78BFA"/>
                    <circle cx="192" cy="100" r="1.6" fill="#A78BFA"/>
                    <circle cx="100" cy="192" r="1.6" fill="#A78BFA"/>
                    <circle cx="8"   cy="100" r="1.6" fill="#A78BFA"/>
                  </g>
                  ...
                  <circle className="glyph-dot" cx="100" cy="100" r="6" fill="#A78BFA"/>
                </svg>
              </div>
            </div>
          </aside>
